...
const AddShows = () => {
  ...
  const currecncy = import.meta.env.VITE_CURRENCY;
    ...
    <>
      ...
      <div className='mt-8'>
          ...
          <div className='inline-flex items-center gap-2 border border-gray-600 px-3 py-2 rounded-md'>
            <p className='text-gray-400 text-sm'>{currecncy}</p>
      ...
      <div className='mt-6'>
          ...
          <div className='inline-flex gap-5 border border-gray-600 p-1 pl-3 rounded-lg'>
            <input type="datetime-local" value={dateTimeInput} onChange={(e) => setDateTimeInput((e.target.value))} className='outline-none rounded-mt'/>
